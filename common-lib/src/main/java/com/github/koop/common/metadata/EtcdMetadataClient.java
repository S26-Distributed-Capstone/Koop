...
public class EtcdMetadataClient implements AutoCloseable {

    private static final Logger LOGGER = Logger.getLogger(EtcdMetadataClient.class.getName());
    ...
    public EtcdMetadataClient(String etcdUrl, String replicaSetKey, String partitionSpreadKey) {
    ...
    public EtcdMetadataClient(String replicaSetKey, String partitionSpreadKey) {
        this(System.getenv("ETCD_URL"), replicaSetKey, partitionSpreadKey);
    }

    public EtcdMetadataClient(Client client, String replicaSetKey, String partitionSpreadKey) {
        this.client = client;
        this.kvClient = client.getKVClient();
        this.watchClient = client.getWatchClient();
        this.objectMapper = new ObjectMapper();
